...
import 'package:samay/data/repositories/agency/agency_repository_dev.dart';
import 'package:samay/data/repositories/agency/agency_repository_fake.dart';
import 'package:samay/data/repositories/agency/agency_repository_impl.dart';
...
class DependencyInjection {
  DependencyInjection() {
    ...
    if (mode == Flavor.fake) {
      ...
      getIt.registerSingleton<AgencyRepository>(AgencyRepositoryDev());
    ...
    getIt.registerSingleton<AddInteractionDeviceUseCase>(
        AddInteractionDeviceUseCase(
            domoticRepository: getIt.get<DomoticRepository>(),
            domoticState: getIt.get<DomoticState>()));
    getIt.registerSingleton<DisconnectDeviceUseCase>(DisconnectDeviceUseCase(
        domoticRepository: getIt.get<DomoticRepository>(),
        domoticState: getIt.get<DomoticState>()));
    //#endregion
    //#region project
